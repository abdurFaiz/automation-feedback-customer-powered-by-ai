    ...
    return (
      <div className="flex-1 max-w-lg py-12 px-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-2xl font-semibold text-gray-900">Account successfully registered!</p>
          <p className="text-gray-500 mt-2">We are redirecting you...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="w-full h-fit max-w-lg mx-auto">
      <div className="text-center">
        ...
        <p className="text-gray-500 dark:text-gray-400">Final step & you're good to go!</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="flex flex-col gap-10">
          <div className='flex flex-col gap-4'>
            <div className="flex flex-col md:flex-row item-center gap-3 justify-center w-full">
              <Input
            ...
            <Button
              ...
              startContent={
                <svg width="20" height="20" viewBox="0 0 24 24">
                  <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4485F4" />
